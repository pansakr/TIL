...
* 파일과 디렉토리의 소유권과 허가권
    ...
    - 파일 허가권
        ...
        - 그리고 첫 번째 rw- 는 소유자의 파일 접근 권한, 두 번째 r-- 는 그룹의 파일 접근 권한, 세 번째 r-- 는 그 외 사용자의 파일 접근 권한을 의미한다
    ...
    - 파일 소유권
        ...
        - sample.txt 파일은 root 라는 사용자가 소유자이며, root 라는 그룹이 소유 그룹이다
...
* 스크립트
    ...
    - 즉, 우리가 평소에 터미널이나 명령 프롬프트에서 한 줄씩 입력하는 명령어들을 하나의 파일(스크립트 파일)에 정리해 두고, 한 번에 실행할 수 있도록 만드는 것ㅣㄴ
