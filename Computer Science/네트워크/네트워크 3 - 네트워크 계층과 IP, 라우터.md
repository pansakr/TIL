...
* IPv4, IPv6의 두가지 버전이 있고 일반적으로 IP를 이야기할 땐 IPv4를 의미한다
    ...
    - IPv4의 주소는 .(옥텟)을 기준으로 8비트(0~255)범의 안의 4개의 10진수로 표현된다
...
* IP 단편화
    ...
    *MUT : 한번에 전송 가능한 IP 패킷의 최대 크기. 헤ㅓ도 포함된다

* IPv4 패킷의 정보

    - IP패킷은 프레임의 페이로드로서 데이터 필드에 명시된다
    ...
    - 클래스풀 주소 체계
        ...
        - A클래스
            ...
            - 나머지 3옥텟 만큼인 2의 24제곱 비트만큼(16,777,216) 호스트 주소를 가질 수 있다
                ...
                - 만약 100 개의 호스트가 있는 T 라는 이름의 네트워크에 120.0.0.0 의 A 클래스 주소를 할당하면 T 네트워크의 주소는 120.0.0.0 이고, 호스트 주소 범위는 120.0.0.1 ~ 120.255.255.255 이다
