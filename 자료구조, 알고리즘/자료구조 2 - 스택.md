...
* 바닥이 막혀있는 통에 데이터를 차곡차곡 쌓아올린 형태를 가진 자료구조

    - 데이터의 입력과 출력 순서는 후입 선출로, 가장 나중에 넣은 데이터를 가장 먼저 꺼낸다

    - 스택에 데이터를 넣는 것을 push, 꺼내는 것을 pop 이라고 한다

    - 자바에서 메서드를 호출하고 실행할 때 프로그램 내부에서 스택을 사용한다

    <img src ="https://github.com/user-attachments/assets/6f738665-0717-4e34-9386-5d4c39b947ef">
...
* 스택 구현
    ...
    <img src ="https://github.com/user-attachments/assets/9e5fb950-a774-4e8a-954f-00df405be4c5">

    <img src ="https://github.com/user-attachments/assets/1919d44a-b004-4710-81d6-4f4d6535f7a1">
