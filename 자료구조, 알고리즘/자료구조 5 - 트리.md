...
* 구성 요소
    ...
    <img src = "https://github.com/user-attachments/assets/ad6f35ef-d990-4058-84f7-86b8a8d8a792" width="500" height="300">
...
* 순서 트리 탐색
    ...
    - 너비 우선 탐색(가로형 탐색) 알고리즘
        ...
        <img src = "https://github.com/user-attachments/assets/c64db6f7-bca3-4ba6-8e43-35d4ef7e95ee" width="500" height="300">

        - 낮은 레벨에서 시작해 왼쪽에서 오른쪽 방향으로 탐색하다가 한 레벨에서 탐색이 끝나면 다음 레벨로 내려가는 방법

    - 깊이 우선 탐색(세로형 탐색) 알고리즘

        <img src = "https://github.com/user-attachments/assets/8a4cabd2-b67e-4a04-bbfa-085f9bed76d8" width="500" height="300">
        ...
        - 깊이 우선 탐색의 여러 패턴
            ...
            <img src = "https://github.com/user-attachments/assets/3eed5b23-80ba-4102-b164-e4a96a47324b" width="500" height="300">
...
* 이진 트리는 인쪽 자식과 오른쪽 자식을 구분한다
    ...
    <img src = "https://github.com/user-attachments/assets/27864c32-b620-4ca4-8b45-66710b692d3f" width="500" height="300">
...
* 예시
    ...
    <img src = "https://github.com/user-attachments/assets/44ece5ac-7002-4e22-9107-0ad050e7b885" width="500" height="300">
